...
- Installed Pi CLI. Version **0.84.3** is the verified compatibility surface;
...
- Pi `0.84.3` is verified and reports `ok`. A different valid semantic version
...
v0 is verified against Pi **0.84.3**. Other semantic versions are explicitly
